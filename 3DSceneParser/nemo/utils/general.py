...
def get_param_samples(cfg):
    _translation_samples = np.linspace(
        cfg.inference.translation_sample.min,
        cfg.inference.translation_sample.max,
        cfg.inference.translation_sample.num,
    )
    translation_samples = np.meshgrid(
