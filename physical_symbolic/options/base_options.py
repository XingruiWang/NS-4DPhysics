...
class BaseOptions():
    ...
    def __init__(self):
        ...
        # superClevr
        self.parser.add_argument('--superclevr_question_path', default='/mnt/data0/xingrui/NSVQA-h5/SuperCLEVR_questions.h5',
                                 type=str, help='path to clevr train questions')
        self.parser.add_argument('--superclevr_scene_path', default='/home/xingrui/vqa/ns-vqa/data/ver_mask/reason/scene_pred.json',
                                 type=str, help='path to clevr train questions')
        self.parser.add_argument('--superclevr_vocab_path', default='/mnt/data0/xingrui/NSVQA-h5/SuperCLEVR_vocab.json',
                                 type=str, help='path to clevr vocab')                                 
        self.parser.add_argument('--superclevr_gt_question_path', default='/mnt/data0/xingrui/ccvl17/ver_mask/questions/superCLEVR_questions_merged.json',
                                 type=str, help='path to clevr train questions')
        self.parser.add_argument('--prob', action="store_true")   
        self.parser.add_argument('--length', default=10000, type=int)
