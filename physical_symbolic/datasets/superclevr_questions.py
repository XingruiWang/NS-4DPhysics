...
class SuperClevrQuestionDataset(Dataset):

    def __init__(self, question_h5_path, max_samples, vocab_json, split = 'val', length = 10000):
    ...
    def __getitem__(self, idx):
        ...
        return question, program, answer, image_idx - min(self.image_idxs), idx